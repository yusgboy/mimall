      ...
      <div class="container clearfix">
        ...
        <div class="content">
          ...
          <div class="item-price">
            {{product.price}}<span class="del">{{product.price}}</span>
          </div>
          <div class="line"></div>
          <div class="item-addr">
            
            <div class="addr"><i class="iconfont icon-wangdianchaxun"></i>北京 北京市 朝阳区 安定门街道</div>
            <div class="stock">有现货</div>
          </div>
          <div class="item-version clearfix">
            <h2>选择版本</h2>
            <div
              class="phone fl" :class="{'checked':version==1}" @click="version=1"
            >
              6GB+64GB 全网通
            </div>
            <div
              class="phone fr" :class="{'checked':version==2}" @click="version=2"
            >
              4GB+64GB 移动4G
            </div>
          </div>
          ...
          <div class="item-total">
            <div class="phone-info clearfix">
              <div class="fl">
                {{product.name}} {{version==1?'6GB+64GB 全网通':'4GB+64GB 移动4G'}} 深空灰
              </div>
              <div class="fr">{{product.price}}</div>
            </div>
            <div class="phone-total">总计：1999元</div>
          </div>
          <div class="btn-group">
